...
beginning_date = start_date + timedelta(days = 500)

while beginning_date < end_date:
    current_date += timedelta(days = 9)
    beginning_date += timedelta(days = 9)
    if beginning_date.weekday() < 5:
        apple_list = fetch_data_list('^VIX', current_date, beginning_date)
        qqq_list = fetch_data_list('SPY', current_date, beginning_date)
        ...
        for i in range(55, len(apple_list)):
            apple_fifty_moving[i] = statistics.mean(qqq_list[i-55:i-5])

        for i in range(205, len(apple_list)):
            apple_twohundred_moving[i] = statistics.mean(qqq_list[i-205:i-5])
        ...
        for i in range(2,len(apple_list)):
            apple_day_change[i] = (qqq_list[i] - qqq_list[i-1])/qqq_list[i-1]
        ...
        for i in range(10, len(apple_list)):
            applepastweek_percent_change[i] = apple_list[i-5]
        ...
        for i in range(5, len(apple_list)):
            applenextweek_percent_change[i] = apple_list[i]
        ...
        vix_ranges = [0,5,7.5,10,15,17.5,20,22.5,25,33,40,50,66,75,500]
        vix_ranges2 = [0,5,10,15,17.5,20,25,33,50,66,500]
        ...
        for a in range(1, len(vix_ranges2)):
            for j in range(1, len(variable_percent_ranges)):
                col_counter = -1
                row_counter += 1
                for k in range(1, len(vix_ranges)):
                    col_counter += 1
                    counter = 0
                    for i in range(1, len(apple_list)):
                        if qqqpastweek_percent_change[i] < variable_percent_ranges[j] and qqqpastweek_percent_change[i] > variable_percent_ranges[j-1] and applepastweek_percent_change[i] < vix_ranges2[a] and applepastweek_percent_change[i] > vix_ranges2[a-1] and applenextweek_percent_change[i] < vix_ranges[k] and applenextweek_percent_change[i] > vix_ranges[k-1]:
                            counter += 1
        ...
        for a in range(1, len(variable_percent_ranges)):
            for j in range(1, len(variable_percent_ranges)):
                ...
                for k in range(1, len(vix_ranges)):
                    ...
                    counter = 0
                    for i in range(1, len(apple_list)):
                        if difference[i] < difference_range[j] and difference[i] > difference_range[j-1] and applepastweek_percent_change[i] < vix_ranges2[a] and applepastweek_percent_change[i] > vix_ranges2[a-1] and applenextweek_percent_change[i] < vix_ranges[k] and applenextweek_percent_change[i] > vix_ranges[k-1]:
                            counter += 1
        ...
        for a in range(1, len(variable_percent_ranges)):
            for j in range(1, len(variable_percent_ranges)):
                ...
                for k in range(1, len(vix_ranges)):
                    ...
                    counter = 0
                    for i in range(1, len(apple_list)):
                        if obv_difference[i] < obv_range[j] and obv_difference[i] > obv_range[j-1] and applepastweek_percent_change[i] < vix_ranges2[a] and applepastweek_percent_change[i] > vix_ranges2[a-1] and applenextweek_percent_change[i] < vix_ranges[k] and applenextweek_percent_change[i] > vix_ranges[k-1]:
                            counter += 1
        ...
        for a in range(1, len(variable_percent_ranges)):
            for j in range(1, len(variable_percent_ranges)):
                ...
                for k in range(1, len(vix_ranges)):
                    ...
                    counter = 0
                    for i in range(1, len(apple_list)):
                        if apple_difference_moving[i] < moving_range[j] and apple_difference_moving[i] > moving_range[j-1] and applepastweek_percent_change[i] < vix_ranges2[a] and applepastweek_percent_change[i] > vix_ranges2[a-1] and applenextweek_percent_change[i] < vix_ranges[k] and applenextweek_percent_change[i] > vix_ranges[k-1]:
                            counter += 1
        ...
        for a in range(1, len(variable_percent_ranges)):
            for j in range(1, len(variable_percent_ranges)):
                ...
                for k in range(1, len(vix_ranges)):
                    ...
                    counter = 0
                    for i in range(1, len(apple_list)):
                        if obv_difference[i] < obv_range[j] and obv_difference[i] > obv_range[j-1] and difference[i] < difference_range[a] and difference[i] > difference_range[a-1] and applenextweek_percent_change[i] < vix_ranges[k] and applenextweek_percent_change[i] > vix_ranges[k-1]:
                            counter += 1
        ...
        for a in range(1, len(variable_percent_ranges)):
            for j in range(1, len(variable_percent_ranges)):
                ...
                for k in range(1, len(vix_ranges)):
                    ...
                    counter = 0
                    for i in range(1, len(apple_list)):
                        if apple_difference_moving[i] < moving_range[j] and apple_difference_moving[i] > moving_range[j-1] and difference[i] < difference_range[a] and difference[i] > difference_range[a-1] and applenextweek_percent_change[i] < vix_ranges[k] and applenextweek_percent_change[i] > vix_ranges[k-1]:
                            counter += 1
        ...
        for a in range(1, len(variable_percent_ranges)):
            for j in range(1, len(variable_percent_ranges)):
                ...
                for k in range(1, len(vix_ranges)):
                    ...
                    counter = 0
                    for i in range(1, len(apple_list)):
                        if apple_difference_moving[i] < moving_range[j] and apple_difference_moving[i] > moving_range[j-1] and obv_difference[i] < obv_range[a] and obv_difference[i] > obv_range[a-1] and applenextweek_percent_change[i] < vix_ranges[k] and applenextweek_percent_change[i] > vix_ranges[k-1]:
                            counter += 1
        ...
        for i in range(1, len(difference_range)):
            counter += 1
            if current_applepastweek_percent_change < vix_ranges[i] and current_applepastweek_percent_change > vix_ranges[i-1]:
        ...
        for i in range(0,14):
            total_list[i] += apple_qqq_list[i]

        for i in range(0,14):
            total_list[i] += apple_macd_list[i]

        for i in range(0,14):
            total_list[i] += apple_obv_list[i]

        for i in range(0,14):
            total_list[i] += apple_moving_list[i]
        
        for i in range(0,14):
            total_list[i] += macd_obv_list[i]
        
        for i in range(0,14):
            total_list[i] += macd_moving_list[i]

        for i in range(0,14):
            total_list[i] += obv_moving_list[i]
        ...
        print(beginning_date, "Guess:", total_list, "Actual:", nextweekchange,"%")
